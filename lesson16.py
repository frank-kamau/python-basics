...
p1 = PermanentEmployee(salary=10000, name='Jane Said', id_number='34567897', gender='F', dob='1990-01-26')
p1.print_details()
p1.print_salary()

t1= TemporaryEmployee('Jim', '23456778', '1995-11-12', 'M', 1000, '2024-12-23')
t1.print_details()
